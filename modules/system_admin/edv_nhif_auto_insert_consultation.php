...
if ($_REQUEST['change'] == true) {
    ...
    $sql = 'UPDATE care_config_global SET `value` = \'' . $_REQUEST['auto_insert_cons_nhif'] . '\', `modify_time` = NOW() WHERE CONVERT(`care_config_global`.`type` USING utf8) = \'auto_insert_consultation_nhif\' LIMIT 1;';
...
if ($auto_insert_consultation_nhif == 1) {
